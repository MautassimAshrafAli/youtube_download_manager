...
Public Class offlineList
    ...
    Private Sub offlineList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim path_ As String = "C:\Users\" + System.IO.Path.GetFileName(s_) + "\Desktop\My_offlineSound_list"
        Dim path_2 As String = "C:\Users\" + System.IO.Path.GetFileName(s_) + "\Desktop\My_offlineVideo_list"
